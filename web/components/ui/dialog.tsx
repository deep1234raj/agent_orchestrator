  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 border border-border bg-surface p-6 shadow-2xl shadow-black/40",
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-sm p-1 text-fg-muted hover:text-fg hover:bg-elevated transition-colors"
        aria-label="Close"
      >
        <X className="h-4 w-4" />
      </DialogPrimitive.Close>
